...
- (Practical Beside Theory) Algorithm implementation & tensorflow
    - http://web.stanford.edu/class/cs20si/syllabus.html 
    - https://www.kadenze.com/courses/creative-applications-of-deep-learning-with-tensorflow/info

- Statistical Deep learning (Core)
...
- Videos:
    - http://cs231n.stanford.edu/ and practical: http://cs231n.github.io/
...
- DL Exotics:
    ...
    - **Generative (Adversarial) Models (GANs, PixelCNN, VAEs, Actor-Critic)**
...
- Paint via DL https://arxiv.org/pdf/1508.06576v1.pdf
- Composing Music DL http://www.hexahedria.com/2015/08/03/composing-music-with-recurrent-neural-networks/
- Best Selfie DL http://karpathy.github.io/2015/10/25/selfie/
